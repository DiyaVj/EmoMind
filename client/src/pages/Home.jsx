  ...
  return (
    <div className="home-page">
        ...
        <Container className="header-container">
          <Row>
            <Col xs="12" lg="6" className="header-text">
              <h1 className="header-brand">Your way to mindfulness!</h1>
              <p className="header-motto">
                Empowering individuals on their journey to improved mental health through daily challenges, journaling, and holistic support.
              </p>
              {user ? (
                <Button
                  style={{ marginLeft: 10 }}
      ...
      <section className="footer">
        Made with <FaHeart style={{ color: "0000" }} />
      </section>
    </div>
  );
};
